        ...
        <b-modal id="login" class="modal" hide-footer>
            ...
            <div class="modalcontainer">
                <div class="loginform">
                    ...
                    <b-form-input id="id" placeholder="아이디를 입력해 주세요"></b-form-input>
                    <label for="pass"><i class="bi bi-lock" />비밀번호</label>
                    <b-form-input type="password" id="pass" placeholder="비밀번호를 입력해 주세요"></b-form-input>
                </div>
                <div class="btnwrap">
            ...
            <div class="modalcontainer">
                <b-form @submit="Joinmember">
                    ...
                    <b-form-group
                        ...
                        label="이메일 수신"
                        label-for="mailing"
                        description="※ 이메일 수신을 허락하면 독자 혜책을 받을 수 있어요">
